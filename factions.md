...
<main>
  <section>
    <h2>Important Factions</h2>
    <p>List the important factions, organizations, or groups in your world. For each faction, consider:</p>
    <ul>
      <li>Name</li>
      <li>Purpose & goals</li>
      <li>Leadership & structure</li>
      <li>Allies & enemies</li>
      <li>Influence & resources</li>
    </ul>
    <h3>Example:</h3>
    <strong>The Iron Circle</strong>
    <p>A secretive guild of artificers controlling trade and technology.</p>
  </section>
  <section>
    <h2>Theme Picker</h2>
