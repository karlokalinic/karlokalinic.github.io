...
<main>
  <section>
    ...
    <p>Document the major historical events and timeline of your world. For each event, consider:</p>
    <ul>
      <li>Date or era</li>
      <li>Event name</li>
      <li>Description</li>
    ...
    <h3>Example:</h3>
    <strong>Year 0: The Sundering</strong>
    <p>The world was split into continents by a cataclysmic magical event.</p>
  </section>
  <section>
    <h2>Theme Picker</h2>
