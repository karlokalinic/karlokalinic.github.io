...
<main>
  <section>
    ...
    <p>Describe important cities, dungeons, landmarks, and other locations. For each location, consider:</p>
    <ul>
      <li>Name</li>
      <li>Type (city, ruin, forest, etc.)</li>
      <li>Description & history</li>
      <li>Notable NPCs or creatures</li>
      <li>Secrets or plot hooks</li>
    </ul>
    <h3>Example:</h3>
    <strong>The Shattered Spire</strong>
    <p>A ruined tower at the heart of a cursed forest, rumored to house forbidden knowledge.</p>
  </section>
  <section>
    <h2>Theme Picker</h2>
