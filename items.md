...
<main>
  <section>
    <h2>Notable Items</h2>
    <p>List notable items, artifacts, and equipment. For each item, consider:</p>
    <ul>
      <li>Name</li>
      <li>Type (weapon, artifact, tool, etc.)</li>
      <li>Description & abilities</li>
      <li>History or origin</li>
      <li>Who possesses it</li>
    </ul>
    <h3>Example:</h3>
    <strong>Blade of the Eclipse</strong>
    <p>A legendary sword that can cut through shadows and light alike.</p>
  </section>
  <section>
    <h2>Theme Picker</h2>
