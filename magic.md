...
<main>
  <section>
    <h2>Magic System</h2>
    <p>Explain the rules, systems, and sources of magic in your world. Consider:</p>
    <ul>
      <li>How is magic accessed or learned?</li>
      <li>What are its limits and costs?</li>
      <li>Are there different types or schools?</li>
      <li>Who can use magic?</li>
      <li>How does society view magic?</li>
    </ul>
    <h3>Example:</h3>
    <strong>The Weave</strong>
    <p>Magic flows through invisible threads that only trained mages can manipulate.</p>
  </section>
  <section>
    <h2>Theme Picker</h2>
