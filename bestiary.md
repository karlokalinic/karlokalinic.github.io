...
<main>
  <section>
    <h2>Bestiary</h2>
    <p>Describe monsters, creatures, and races found in your world. For each entry, consider:</p>
    <ul>
      <li>Name</li>
      <li>Type (beast, undead, elemental, etc.)</li>
      <li>Description & abilities</li>
      <li>Habitat</li>
      <li>Behavior & lore</li>
    </ul>
    <h3>Example:</h3>
    <strong>Frost Wyrm</strong>
    <p>A massive ice serpent that haunts the northern glaciers, feared by all.</p>
  </section>
  <section>
    <h2>Theme Picker</h2>
