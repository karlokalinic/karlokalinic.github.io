...
<main>
  <section>
    <h2>Major Quests</h2>
    <p>Outline major quests, story arcs, and plot hooks. For each quest, consider:</p>
    <ul>
      <li>Title</li>
      <li>Objective</li>
      <li>Key NPCs</li>
      <li>Locations involved</li>
      <li>Obstacles & rewards</li>
    </ul>
    <h3>Example:</h3>
    <strong>The Lost Heir</strong>
    <p>Find the missing heir to the throne before a rival faction seizes power.</p>
  </section>
<section>
  <h2>Theme Picker</h2>
